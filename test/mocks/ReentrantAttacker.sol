...
contract ReentrantAttacker {
    ...
    function registerAsWallet(uint256 inactivityPeriod, address backup) external payable {
        ...
        target.register{value: msg.value}(backup, inactivityPeriod, IAeternumVault.SubscriptionTier.Free);
    }
    ...
    receive() external payable {
        if (attackEnabled) {
            ...
            try target.register{value: 0}(owner, 180 days, IAeternumVault.SubscriptionTier.Free) {} catch {}
        }
    }
